package com.example.matdongsan.util.upload.controller;
...
import com.example.matdongsan.util.upload.controller.dto.PresignedUrlListRequestDto;
import com.example.matdongsan.util.upload.controller.dto.PresignedUrlResponseDto;
import com.example.matdongsan.util.upload.domain.FileType;
import com.example.matdongsan.util.upload.service.S3PresignedUrlService;
...
public class S3PresignedUrlController {
    ...
    public ResponseEntity<RestApiResponse<ResultResponse<PresignedUrlResponseDto>>> generatePresignedUrl(
        ...
        return RestApiResponse.successResult(ResponseCode.OK, result);
    }

    @Operation(summary = "다중 Presigned URL 발급", description = "여러 개의 파일 이름을 받아 각각 Presigned URL을 발급")
    @PostMapping("/presigned-urls")
    public ResponseEntity<RestApiResponse<ListResponse<PresignedUrlResponseDto>>> generatePresignedUrls(
        ...
        return RestApiResponse.successList(ResponseCode.OK, result);
    }
}
