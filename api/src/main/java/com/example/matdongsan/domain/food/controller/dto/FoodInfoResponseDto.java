package com.example.matdongsan.domain.food.controller.dto;
...
public class FoodInfoResponseDto {
    ...
    public static FoodInfoResponseDto of(Food food, Boolean isLiked) {
        return FoodInfoResponseDto.builder()
                ...
                .lastFeaturedDate(food.getLastFeaturedAt() != null ? food.getLastFeaturedAt().toLocalDate() : null)
                .isLiked(isLiked)
                .seasonMonths(food.getSeasonMonths().toString())
                .regions(food.getRegions())
                .benefits(food.getBenefits())
                .buyingTips(food.getBuyingTips())
                .preparationTips(food.getBuyingTips())
                .nutrients(FoodNutrientResponseDto.of(food.getNutrients()))
                .build();
    }
